...
public class FormLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("GTrack Login");
    ...
    Usuario usuarioAutenticado = dao.autenticar(usuario, senha);

    if (usuarioAutenticado != null) {
        JOptionPane.showMessageDialog(this, "Login realizado com sucesso!");

        // PASSA O USUARIO PARA O FORM PRINCIPAL
        FormPrincipal form = new FormPrincipal(usuarioAutenticado);
